/mob/living/carbon/human/species/human/northern/standard
	race = /datum/species/human/northern/standard

/datum/species/human/northern/standard
	name = "Standard"
	id = "standard"
	desc = "<b>Standard</b><br>\
	You are the bog standard, nothing special about you at all. For the most part."
	...
	OFFSET_SHIRT = list(0,0), OFFSET_ARMOR = list(0,1), OFFSET_HANDS = list(0,0), OFFSET_UNDIES = list(0,0), \
	...
	specstats = list("strength" = 2, "perception" = 1, "intelligence" = 0, "constitution" = 1, "endurance" = 3, "speed" = 1, "fortune" = 0)
	specstats_f = list("strength" = 2, "perception" = 1, "intelligence" = 0, "constitution" = 1, "endurance" = 3, "speed" = 1, "fortune" = 0)
	enflamed_icon = "widefire"

/datum/species/human/northern/standard/check_roundstart_eligible()
	return TRUE

/datum/species/human/northern/standard/get_skin_list()
...
/datum/species/human/northern/standard/get_hairc_list()
	return sortList(list(
	"blond - pale" = "9d8d6e",
	"blond - dirty" = "88754f",
...
/datum/species/human/northern/standard/random_name(gender,unique,lastname)
...
/datum/species/human/northern/standard/random_surname()
