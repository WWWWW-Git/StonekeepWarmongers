...
/mob/living/carbon/update_stress()
	...
	if(stress != oldstress)
		if(stress > oldstress)
			...
			to_chat(src, "<span class='green'>ᛉ A moment of peace. ᛉ</span>") // in a war that never ends tonight today were all brothers we drink and unite now christmas has arrived and the snow turns the ground white
