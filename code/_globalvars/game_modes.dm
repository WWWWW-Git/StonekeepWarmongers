GLOBAL_VAR_INIT(master_mode, "warmongers") //"extended"
GLOBAL_VAR_INIT(secret_force_mode, "warmongers") // if this is anything but "secret", the secret rotation will forceably choose this mode
