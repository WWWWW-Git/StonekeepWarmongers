...
//		music -= old_login_music
	...
	login_music = pick('sound/music/warmongrels.ogg', 'sound/music/smellofblackpowder.ogg', 'sound/music/drama.ogg', 'sound/music/thomas.ogg', 'sound/music/draft.ogg', 'sound/music/rainbow.ogg')
	SSevents.getHoliday()
