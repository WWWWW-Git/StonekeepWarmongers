...
#define ALL_RACES_LIST			list("fat", "standard", "bulky", "tiefling", "aasimar", "orc", "zizombie")

#define ALL_RACES_LIST_NAMES		list("Fat", "Standard", "Bulky", "Elf", "Dwarf","Tiefling", "Aasimar")
